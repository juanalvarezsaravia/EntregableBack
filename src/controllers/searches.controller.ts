...
import { createSearchService, getSearchsService, getSearchService, updateSearchService, deleteSearchService } from "../services/searches.service";
...
export const deleteSearch = async (req: Request, res: Response) => {
    ...
    return res.status(200).json({ message: `Search ${search.results} fue eliminado correctamente` })
}
